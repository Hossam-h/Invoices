                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير الغير المدفوعة
                                {{ number_format(\App\Invoice::where('Value_Status', 2)->count()) }} </p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-down text-white"></i>
                            <span class="text-white op-7">

                                %{{number_format (\App\Invoice::where('Value_Status',2)->count()  / \App\Invoice::count() * (100) ,2)}}
                            </span>
                        </span>
                    </div>
                </div>
                    ...
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7"> عدد الفواتير المدفوعة
                                {{ number_format(\App\Invoice::where('Value_Status', 1)->count()) }} </p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-up text-white"></i>
                            <span class="text-white op-7">
                                %{{number_format (\App\Invoice::where('Value_Status',1)->count()  / \App\Invoice::count() * (100) ,2)}}
                            </span>
                        </span>
                    </div>
                </div>
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">عدد الفواتير المدفوعة جزئيا
                                {{ number_format(\App\Invoice::where('Value_Status', 3)->count()) }} </p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-down text-white"></i>
                            <span class="text-white op-7">
                                %{{number_format (\App\Invoice::where('Value_Status',3)->count()  / \App\Invoice::count() * (100) ,2)}}</span>
                        </span>
                    </div>
                </div>
            </div>
